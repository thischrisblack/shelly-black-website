                ...
                <div className={styles.content}>
                    ...
                    <div className={shopStyles.containerShop}>
                        ...
                        <div className={shopStyles.details}>
                            <p>
                                Are you a purrrocessing archivist? If yes,
                                you'll want to get your paws on this enamel pin
                                of a kitty in an archival storage box. This is
                                also the purrfect gift for the archivist,
                                librarian, or historian in your life who loves
                                cats. Available for purrchase while supplies
                                last.
                            </p>
                            <p>
                                1 x 1.25 inches, black metal finish and black
                                rubber clutch.
                            </p>
                        </div>
                        <div className={shopStyles.button}>
                            <p className={shopStyles.price}>$10.99</p>
                            <p className={shopStyles.shipping}>
                                <i>plus $4.00 shipping</i>
                            </p>
                            <form
